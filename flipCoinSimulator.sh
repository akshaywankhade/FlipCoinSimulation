...
do
	...
	if [[ singlet[$counter] -eq IS_HEAD ]]
	then
		(( headCount++ ))
	elif [[ singlet[$counter] -eq IS_TAIL ]]
	then
		(( tailCount++ ))
	fi
	(( counter++ ))
...
do
	...
	if [[ doublet[$counter] -eq $IS_HEAD_HEAD ]]
	then
		(( headHeadCount++ ))
	elif [[ doublet[$counter] -eq $IS_HEAD_TAIL ]]
	then
		(( headTailCount++ ))
	elif [[ doublet[$counter] -eq $IS_TAIL_HEAD ]]
	then
		(( tailHeadCount++ ))
	elif [[ doublet[$counter] -eq $IS_TAIL_TAIL ]]
	then
      (( tailTailCount++ ))
	fi
	(( counter++ ))
...
do
	...
	if [[ triplet[$counter] -eq $IS_HEAD_HEAD_HEAD ]]
	then
		(( headHeadHeadCount++ ))
	elif [[ triplet[$counter] -eq $IS_HEAD_HEAD_TAIL ]]
	then
		(( headHeadtailCount++ ))
	elif [[ triplet[$counter] -eq $IS_HEAD_TAIL_HEAD ]]
	then
		(( headTailHeadCount++ ))
	elif [[ triplet[$counter] -eq $IS_TAIL_HEAD_HEAD ]]
	then
		(( tailHeadHeadCount++ ))
	elif [[ triplet[$counter] -eq $IS_HEAD_TAIL_TAIL ]]
	then
		(( headTailTailCount++ ))
	elif [[ triplet[$counter] -eq $IS_TAIL_HEAD_TAIL ]]
	then
		(( tailHeadTailCount++ ))
	elif [[ triplet[$counter] -eq $IS_TAIL_TAIL_HEAD ]]
	then
		(( tailTailHeadCount++ ))
	elif [[ triplet[$counter] -eq $IS_TAIL_TAIL_TAIL ]]
	then
		(( tailTailTailCount++ ))
	fi
	(( counter++ ))
